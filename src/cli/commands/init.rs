...
pub async fn run(runner: &mut CliRunner, args: InitArgs) -> Result<(), Box<dyn std::error::Error>> {
    ...
    match language.as_str() {
        "rust" => {
            ...
            runner.print_info("  devkit analyze");
        }
        "python" => {
    ...
    runner.print_info("  devkit interactive  # Start interactive development mode");
...
async fn initialize_git_repository(
    ...
    std::process::Command::new("git")
        .args(&["commit", "-m", "Initial commit from devkit init"])
        .current_dir(project_path)
        .output()?;
...
async fn create_agentic_config(
    ...
    let config_content = format!(
        r#"# Devkit Configuration
# This file was generated by `devkit init`
...
fn rust_template_files() -> HashMap<PathBuf, String> {
    ...
    files.insert(
        ...
        r#"//! {{project_name}} - A devkit project
//!
//! This project was generated by Devkit.
...
fn main() {
    ...
    println!("This project was created with devkit.");
...
//!
//! This library was generated by Devkit.
...
A Rust project created with Devkit.
...
devkit generate "create a function that processes user input"
```
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    print("This project was created with devkit.")
    print(hello_world())
...
A Python project created with Devkit.
...
export function main(): void {
    ...
    console.log("This project was created with devkit.");
...
A TypeScript project created with Devkit.
