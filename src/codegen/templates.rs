...
pub fn {{name}}({{parameters}}) -> {{return_type}} {{
    {{body}}
            ...
            variables: vec![
                ...
                TemplateVariable::optional("body", "Function body", r#"todo!("Implement this function")"#),
            ],
        });
        
        templates.insert("rust_struct".to_string(), Template {
...
pub struct {{name}} {{
    {{fields}}
            ...
            variables: vec![
                ...
                TemplateVariable::optional("description", "Struct description", "Generated struct"),
                TemplateVariable::optional("fields", "Struct fields", "// Add fields here"),
            ],
        });
        
        templates.insert("rust_impl".to_string(), Template {
    ...
    {{methods}}
        ...
        templates.insert("rust_test".to_string(), Template {
...
mod tests {{
    ...
    fn {{test_name}}() {{
        {{test_body}}
            ...
            variables: vec![
                ...
                TemplateVariable::optional("test_body", "Test body", r#"assert!(true, "Test not implemented");"#),
            ],
        });
    ...
    {{body}}"#.to_string(),
        ...
        templates.insert("python_class".to_string(), Template {
    ...
    {{methods}}"#.to_string(),
            variables: vec![
                ...
                TemplateVariable::optional("description", "Class description", "Generated class"),
...
function {{name}}({{parameters}}) {{
    {{body}}
            ...
            variables: vec![
                ...
                TemplateVariable::optional("return_description", "Return value description", "void"),
